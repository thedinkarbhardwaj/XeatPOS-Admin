...
import com.xeatpos.data.ResponsePreparingOrderDetails
...
class PrintPreparingOrderActivity  : BaseActivity() {

    lateinit var binding: ActivityPosprintBinding

    lateinit var response: ResponsePreparingOrderDetails.PreparingOrderDetails
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            ...
            response = responseBefore as ResponsePreparingOrderDetails.PreparingOrderDetails
           ...
           // Glide.with(this).load(response.website_qrcode).into(binding.imgQR)
            ...
            for (item in response.order_item_data) {
                ...
                val txt_quentity =
                    v.findViewById<View>(R.id.txt_quentityPrint) as TextView
                val txt_amount = v.findViewById<View>(R.id.txt_amountPrint) as TextView
                val txt_AddOns = v.findViewById<View>(R.id.txt_AddOnsPrint) as TextView
                val layoutAddOnDynamic =
                    v.findViewById<View>(R.id.layoutAddOnDynamicPrint) as LinearLayout
